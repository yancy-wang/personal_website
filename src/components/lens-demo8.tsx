      ...
      <div className="w-full relative rounded-3xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#1D2235] to-[#121318] p-8 my-10">
        ...
        <div className="relative z-10">
          ...
          >
            ...
            autre is the starlight that seeps out from the cracks in the symbolic world, guiding the direction of desire while also announcing a fate that can never be reached.
            </p>
          </motion.div>
        </div>
      </div>
